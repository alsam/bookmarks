    ...
    + ROS education
        ...
        + ROS2 : **R**eal **T**ime **P**ublish **S**ubscribe -- **RTPS** / **D**ata **D**istribution **S**ervice -- **DDS**
            ...
            + [PX4 Autopilot](https://github.com/PX4)
                + [Estimation & Control Library for Guidance, Navigation and Control Applications](https://github.com/PX4/ecl)
                + [LA for PX4 Lightweight, dependency free Matrix library (BSD)](https://github.com/PX4/Matrix)
                + [PX4 Autopilot Software](https://github.com/PX4/Firmware)
                + [ROS/ROS2 messages that match the uORB messages counterparts under PX4 Firmware](https://github.com/PX4/px4_msgs)
...
+ Robot Simulators
    + [Robot simulator with realistic 3D physics](https://github.com/georgmartius/lpzrobots)
        + [Research Network for Self-Organization of Robot Behavior](http://robot.informatik.uni-leipzig.de/software/?lang=en)
        + [The Playful Machine](http://www.playfulmachines.com/)
            + [The Playful Machine book](http://www.playfulmachines.com/the-playful-machine.pdf)
    + [V-REP, Gazebo or ARGoS? A Robot Simulators Comparison](http://lenkaspace.net/tutorials/programming/robotSimulatorsComparison)
